...
def configSettings(master):
	...
	modeSelection.config(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
	modeSelections = root.nametowidget(modeSelection.menuname)
	modeSelections.configure(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
	...
	rectSelection.config(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
	rectSelections = root.nametowidget(rectSelection.menuname)
	rectSelections.configure(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
	...
	cmapSelection.config(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
	cmapSelections = root.nametowidget(cmapSelection.menuname)
	cmapSelections.configure(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
	...
	if(master['settings']['mode'] == 'OpenCV_SGBM' or master['settings']['mode'] == 'OpenCV_BM'):
		...
		disSelection.config(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
		disSelections = root.nametowidget(disSelection.menuname)
		disSelections.configure(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
	...
	if(master['settings']['mode'] == 'OpenCV_SGBM' or master['settings']['mode'] == 'OpenCV_BM'):
		...
		reSelection.config(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
		reSelections = root.nametowidget(reSelection.menuname)
		reSelections.configure(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
	...
	if(sys.platform == 'linux'):
		...
		flashSelection.config(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
		flashSelections = root.nametowidget(flashSelection.menuname)
		flashSelections.configure(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
	...
	if(programMode == 1):
		...
		exposSelection.config(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
		exposSelections = root.nametowidget(exposSelection.menuname)
		exposSelections.configure(font=tkFont.Font(family='Arial',size=3,weight=tkFont.BOLD))
